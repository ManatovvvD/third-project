            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="cart">
                        ...
                        <h1 class="cart-title">In Your Shopping Cart: <span class="c-primary">{{Cart::getContent()->count()}} items</span></h1>
                        ...
                        <table class="shop_table cart">
                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-remove">
                                    <a href="{{route('cart.delete',['id'=>$pdt->id])}}" class="product-del remove" title="Remove this item">
                                ...
                                <td class="product-quantity">
                                    ...
                                    <div class="quantity">
                                        <a href="{{route('cart.decr', ['id' => $pdt->id, 'qty' => $pdt->quantity])}}" class="quantity-minus">-</a>
                                        <input title="Qty" class="email input-text qty text"  value="{{$pdt->quantity}}" type="text" placeholder="1" readonly>
                                        <a href="{{route('cart.incr', ['id' => $pdt->id, 'qty' => $pdt->quantity])}}" class="quantity-plus">+</a>
                                    </div>

                                </td>

                                <td class="product-subtotal">
                                    <h5 class="total amount">${{Cart::get($pdt->id)->getPriceSum()}}</h5>
                                </td>
